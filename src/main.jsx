...
// React 19 + react-helmet-async v3: Helmet renders managed <head> tags as
...
// Fix: remove the prerendered Helmet-managed tags before hydration so React 19
// creates one clean set. Non-JS crawlers already saw the static HTML version.
