...
export function AdScriptLoader() {
  const adsReady = useAdsReady(250);
...
export function AdSlot({ id, className = '', reserveSpace = true, delayMs = 2500 }) {
...
export function LazyAd({ className = '', parentUnit = 'GD_Game_Bottom', reserveSpace = true, delayMs = 2500 }) {
